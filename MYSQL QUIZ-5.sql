...
-- 36.Create a stored procedure to insert a new customer into the Customers table
DELIMITER //
...
CALL InsertCustomer('John', 'Doe', 'john.doe@example.com', '1234567890', '1990-01-01');
...
INSERT INTO Customers (FirstName, LastName, Email, Phone, DateOfBirth)
VALUES ('Alice', 'Johnson', 'alice.johnson@example.com', '1234567890', '1995-07-14');
